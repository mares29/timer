...
<div class="grid grid-cols-2 gap-4 w-full max-w-md mx-auto">
	{#if timer.status === 'running'}
		<button
			onclick={() => timer.pause()}
			class="col-span-2 bg-surface-hover hover:bg-surface-active text-foreground font-medium py-4 px-8 rounded-full shadow-lg border border-border transform transition active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
		>
			<div class="w-3 h-3 rounded-sm bg-warning-500">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 text-foreground" viewBox="0 0 20 20" fill="currentColor">
	...
	<button
		...
		class="col-span-1 mt-2 text-muted-foreground hover:text-foreground text-sm font-medium py-2 px-4 rounded-full transition-colors disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer flex items-center justify-center gap-2"
	>
		<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
	...
	<button
		...
		class="col-span-1 mt-2 text-muted-foreground hover:text-foreground text-sm font-medium py-2 px-4 rounded-full transition-colors cursor-pointer flex items-center justify-center gap-2"
	>
		<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
